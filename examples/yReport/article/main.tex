...
\fancyhead[RO]{{\renewcommand{\\}{ }\leftmark\ \hspace{1mm} \inColor{\textsc{\runtitle}}}}
\fancyhead[LE]{{\renewcommand{\\}{ }\inColor{\textsc{\runtitle}} \hspace{1mm} \leftmark}}
...
\begin{document}
	...
	\sideNote{\sideTitleColor{Short history of XYZ}\\
